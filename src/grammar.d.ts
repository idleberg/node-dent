...
export type StartRuleNames = "Script";
export interface ParseOptions<T extends StartRuleNames = "Script"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"Script">>(
  input: string,
  options?: Options,
): any;
